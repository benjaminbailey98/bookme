...
// key. API keys should be stored in Cloud Secret Manager so that access to these
...
// an API key at https://aistudio.google.com/app/apikey If you are using Vertex
